...
const Art_Metric = () => {
  return (
    <>
      ...
      <div className="Us_In">
        <h5>
          The metric system, a globally recognized standard for measurement,
          ...
          universally accepted SI system.
        </h5>
      </div>
      <div className="Us">
        <h3>Historical Background:</h3>
        <br />
        The metric system originated during the French Revolution in the late
        ...
        leading to some differences in unit definitions and practices.
        <div className="Us">
          <h3>Varieties of Metric Systems:</h3>
          <br />
          <h5>1. Original French Metric System:</h5>
          The original metric system introduced in France in 1799 had base units
          ...
          The CGS system, an adaptation of the metric system, replaced the
          ...
          Another variation, the MKS system, emerged with the meter, kilogram,
          ...
          unit sizes for everyday measurements.
          <h5>4. International System of Units (SI):</h5>
          The SI system, established in 1960 and periodically updated, is the
          ...
          the kilogram is defined using the Planck constant.
        </div>
        <div className="Us">
          <h3>Differences and Challenges:</h3>
          <br />
          <h5>1. Unit Definitions:</h5>
          Variations in definitions, such as the initial definition of the
          meter, led to inconsistencies among early metric systems.
          <h5>2. Practicality:</h5>
          Some systems, like CGS, faced challenges in practical applications due
          to unit sizes that were either too small or too large for certain
          fields.
          <h5>3. Standardization:</h5>
          The lack of a standardized system hindered international communication
          and collaboration until the widespread adoption of the SI system
        </div>
        <div className="Us">
          <h3>Conclusion:</h3>
          <br />
          The metric system has evolved over time, with different variations
          ...
          seamless communication in a diverse range of disciplines.
        </div>
      </div>
