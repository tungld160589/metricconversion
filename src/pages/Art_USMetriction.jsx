...
const Art_USMetriction = () => {
  return (
    <>
      ...
      <div className="Us_In">
        <h5>
          <p className="US1"> The United States, like many other countries, has a rich history of
      ...
      <div className="Us">
        ...
        <p className="US1">Derived from the English system, these units are commonly used for
          ...
          and home improvement projects.</p> <br />
        <h5>2. Miles:</h5>
        <p className="US1">Miles are used to measure longer distances, especially in the context of
          road travel. The mile is still the standard unit for expressing
          distances on road signs and maps across the United States.</p> <br />
        <h5>3. Surveyor's Units:</h5>
        <p className="US1">In land surveying, the chain (66 feet), rod (16.5 feet or 1/4 chain),
          and acre (43,560 square feet) are traditional units that have historical
          roots. These units are often encountered in property descriptions and legal documents.</p>
      ...
      <div className="Us">
        ...
        <p className="US1">Pounds and ounces are widely used for measuring weight in the United
          States. From grocery store purchases to body weight, these units remain
          ingrained in daily life.</p> <br />
        <h5>2.Tons:</h5>
        <p className="US1">Tons are used to measure larger quantities of weight, particularly in
          industries like shipping, construction, and mining.</p>
      </div>
      <div className="Us">
        <h3>Temperature:</h3>
        <br />
        <h5>1.Fahrenheit:</h5>
        <p className="US1">The Fahrenheit scale is the standard unit of temperature in the United
          States for weather forecasts, household thermometers, and cooking. It
          differs from the Celsius scale used in the metric system.</p>
      </div>
      <div className="Us">
        <h3>Legacy and Everyday Use</h3>
        <br />
        <p className="US1">While the metric system is the standard in many scientific and global
