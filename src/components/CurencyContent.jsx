  ...
  return (
    <>
      <ul className="ul-convert-content">
        ...
        <p className="span-convert-content">
          The monetary policy of the United States is conducted by the Federal
          Reserve System, which acts as the nation's central bank.
        </p>
        <p className="span-convert-content">
          ...
          towards the end of the Second World War. The dollar is the most widely
          used currency in international transactions, and a free-floating
          currency. It is also the official currency in several countries and
          the de facto currency in many others, with Federal Reserve Notes {"("}
        ...
        <p className="span-convert-content">
          ...
          exclusively using banknotes, with lower denominations printed on paper
          and denominations over 10,000 dong, worth about 40¢ dollar or euro,
          printed on polymer. As of 2022, no coins are used. Generally, Vietnam
          is moving towards digital payments. The 500,000-dong note {"("}VND
          {")"} is the highest-denomination banknote in circulation in Vietnam.
          The note is dark blue in color and has been in circulation since 2003
        </p>
        <li className="li-convert-content">
          <h4>EUR:</h4>
        </li>
        ...
        <p className="span-convert-content">
          ...
          European Union, by four European microstates that are not EU members,
          the British Overseas Territory of Akrotiri and Dhekelia, as well as
          unilaterally by Montenegro and Kosovo. Outside Europe, a number of
          special territories of EU members also use the euro as their currency.
          Additionally, over 200 million people worldwide use currencies pegged
          to the euro.
        </p>
        <p className="span-convert-content">
        ...
        <p className="span-convert-content">
          ...
          Unit {"("}ECU{")"} at a ratio of 1:1 {"("}US$1.1743 at the time{")"}.
          Physical euro coins and banknotes entered into circulation on 1
          January 2002, making it the day-to-day operating currency of its
          original members, and by March 2002 it had completely replaced the
          former currencies.
        </p>
        <p className="span-convert-content">
          Between December 1999 and December 2002, the euro traded below the US
          dollar, but has since traded near parity with or above the US dollar,
          peaking at US$1.60 on 18 July 2008 and since then returning near to
          its original issue rate. On 13 July 2022, the two currencies hit
          parity for the first time in nearly two decades due in part to the
        ...
        <p className="span-convert-content">
          ...
          system, with the yen defined as 1.5 g {"("}0.048 troy ounces{")"} of
          gold, or 24.26 g {"("}0.780 troy ounces{")"} of silver, and divided
          decimally into 100 sen or 1,000 rin. The yen replaced the previous
          Tokugawa coinage as well as the various hansatsu paper currencies
          issued by feudal han
        ...
        <p className="span-convert-content">
          ...
          stabilize the Japanese economy, the exchange rate of the yen was fixed
          at ¥360 per US$ as part of the Bretton Woods system. When that system
          was abandoned in 1971, the yen became undervalued and was allowed to
          float. The yen had appreciated to a peak of ¥271 per US$ in 1973, then
          underwent periods of depreciation and appreciation due to the 1973 oil
          crisis, arriving at a value of ¥227 per US$ by 1980.
        </p>
        <p className="span-convert-content">
          Since 1973, the Japanese government has maintained a policy of
          currency intervention, so the yen is under a "dirty float" regime. The
          Japanese government focused on a competitive export market, and tried
          to ensure a low exchange rate for the yen through a trade surplus. The
          Plaza Accord of 1985 temporarily changed this situation; the exchange
          rate fell from its average of ¥239 per dollar in 1985 to ¥128 in 1988
          and led to a peak rate of ¥80 against the US$ in 1995, effectively
          increasing the value of Japan's GDP in dollar terms to almost that of
          the United States. Since that time, however, the world price of the
          yen has greatly decreased. The Bank of Japan maintains a policy of
          zero to near-zero interest rates and the Japanese government has
