    ...
    <>
      <ul className="ul-convert-content">
        ...
        <p className="span-convert-content">
          ...
          imperial ounce. It is primarily used in the United States to measure
          packaged foods and food portions, postal items, areal density of
          fabric and paper, boxing gloves, and so on, but it is sometimes also
          used elsewhere in the Anglosphere.
        </p>
        <p className="span-convert-content">
          Although the avoirdupois ounce is the mass measure used for most
          purposes, the 'troy ounce' of exactly 31.1034768 g is used instead for
          the mass of precious metals such as gold, silver, platinum, palladium,
          rhodium, etc.
        </p>
        <li className="li-convert-content">
          <h4>Grams:</h4>
        ...
        <p className="span-convert-content">
          Originally defined as of 1795 as "the absolute weight of a volume of
          pure water equal to the cube of the hundredth part of a metre {"["}1
          cm<sup>3</sup>
          {"]"}, and at the temperature of melting ice", the defining
          temperature {"("}≈0 °C{")"} was later changed to 4 °C, the temperature
          of maximum density of water.
        </p>
        <p className="span-convert-content">
          However, by the late 19th century, there was an effort to make the
          base unit the kilogram and the gram a derived unit. In 1960, the new
          International System of Units defined a gram as one one-thousandth of
          a kilogram {"("}i.e., one gram is 1×10−3 kg{")"}. The kilogram, as of
          2019, is defined by the International Bureau of Weights and Measures
        ...
        <p className="span-convert-content">
          ...
          "lb"{")"}. The English word pound is cognate with, among others,
          German Pfund, Dutch pond, and Swedish pund. These units are now
          designated as historical and are no longer in common usage, being
          replaced by the metric system.
        </p>
        <p className="span-convert-content">
          Usage of the unqualified term pound reflects the historical conflation
          of mass and weight. This accounts for the modern distinguishing terms
        ...
        <p className="span-convert-content">
          The kilogram is defined in terms of the Planck constant, the second,
          and the metre, both of which are based on fundamental physical
          constants. This allows a properly equipped metrology laboratory to
          calibrate a mass measurement instrument such as a Kibble balance as
          the primary standard to determine an exact kilogram mass
        </p>
        <p className="span-convert-content">
          ...
          per million. In 1799, the platinum Kilogramme des Archives replaced it
          as the standard of mass. In 1889, a cylinder of platinum-iridium, the
          International Prototype of the Kilogram {"("}IPK{")"}, became the
          standard of the unit of mass for the metric system and remained so for
          130 years, before the current standard was adopted in 2019.
        </p>
        <li className="li-convert-content">
          <h4>Short Tons:</h4>
        </li>
