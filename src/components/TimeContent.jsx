  ...
  return (
    <>
      <ul className="ul-convert-content">
        ...
        <p className="span-convert-content">
          This current definition was adopted in 1967 when it became feasible to
          define the second based on fundamental properties of nature with
          ...
          intervals to civil time to keep clocks in sync with Earth's rotation.
        </p>
        <li className="li-convert-content">
          <h4>Hour:</h4>
        </li>
        ...
        <p className="span-convert-content">
          ...
          variable measure of 1⁄12 of the night or daytime. Such seasonal hours,
          also known as temporal hours or unequal hours, varied by season and
          latitude.
        </p>
        <p className="span-convert-content">
          Equal hours or equinoctial hours were taken as 1⁄24 of the day as
          measured from noon to noon; the minor seasonal variations of this unit
          were eventually smoothed by making it 1⁄24 of the mean solar day.
          Since this unit was not constant due to long term variations in the
          Earth's rotation, the hour was finally separated from the Earth's
          rotation and defined in terms of the atomic or physical second.
        </p>
        <p className="span-convert-content">
          In the modern metric system, hours are an accepted unit of time
          defined as 3,600 atomic seconds. However, on rare occasions an hour
          may incorporate a positive or negative leap second, effectively making
          it appear to last 3,599 or 3,601 seconds, in order to keep UTC within
          0.9 seconds of UT1, the latter of which is based on measurements of
          the mean solar day.
        </p>
        <li className="li-convert-content">
          <h4>Day:</h4>
        ...
        <p className="span-convert-content">
          A collection of sequential days is organized into calendars as dates,
          almost always into weeks, months and years. A solar calendar organizes
          dates based on the Sun's annual cycle, giving consistent start dates
          for the four seasons from year to year. A lunar calendar organizes
          dates based on the Moon's lunar phase.
        </p>
        <p className="span-convert-content">
          In common usage, a day starts at midnight, written as 00:00 or 12:00
          am in 24- or 12-hour clocks, respectively. Because the time of
          midnight varies between locations, time zones are set up to facilitate
          the use of a uniform standard time. Other conventions are sometimes
          used, for example the Jewish religious calendar counts days from
          sunset to sunset, so the Jewish Sabbath begins at sundown on Friday.
          In astronomy, a day begins at noon so that observations throughout a
          single night are recorded as happening on the same day.
        </p>
        <p className="span-convert-content">
          In specific applications, the definition of a day is slightly
          modified, such as in the SI day {"("}exactly 86,400 seconds{")"} used
          for computers and standards keeping, local mean time accounting of the
          Earth's natural fluctuation of a solar day, and stellar day and
          sidereal day {"("}using the celestial sphere{")"} used for astronomy.
          In most countries outside of the tropics, daylight saving time is
          practiced, and each year there will be one 23-hour civil day and one
          25-hour civil day. Due to slight variations in the rotation of the
          Earth, there are rare times when a leap second will get inserted at
          the end of a UTC day, and so while almost all days have a duration of
          86,400 seconds, there are these exceptional cases of a day with 86,401
          seconds {"("}in the half-century spanning 1972 through 2022, there
          have been a total of 27 leap seconds that have been inserted, so
          roughly once every other year{")"}.
        </p>
        <li className="li-convert-content">
          <h4>Week:</h4>
        </li>
        ...
        <p className="span-convert-content">
          The modern seven-day week can be traced back to the Babylonians, who
          used it within their calendar. Other ancient cultures had different
          week lengths, including ten in Egypt and an eight-day week for
          Etruscans. The Etruscan week was adopted by the Ancient Romans, but
          they later moved to a seven-day week, which had spread across Western
          Asia and the Eastern Mediterranean. In 321 AD, Emperor Constantine
          officially decreed a seven-day week in the Roman Empire, including
          making Sunday a public holiday. This later spread across Europe, then
          the rest of the world.
        </p>
        <p className="span-convert-content">
          In English, the names of the days of the week are Monday, Tuesday,
          Wednesday, Thursday, Friday, Saturday, and Sunday. In many languages,
          the days of the week are named after gods or planets visible to the
          eye. Such a week may be called a planetary week. Certain weeks within
          a year may be designated for a particular purpose, such as Holy Week
          in Christianity, Golden Week in China, and National Family Week in
          Canada. More informally, certain groups may advocate awareness weeks,
          which are designed to draw attention to a certain subject or cause.
          The term "week" may also be used to refer to a sub-section of the
          week, such as the workweek and weekend.
        </p>
        <li className="li-convert-content">
          <h4>Month</h4>
        </li>
