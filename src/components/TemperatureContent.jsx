  ...
  return (
    <>
      <ul className="ul-convert-content">
        ...
        <p className="span-convert-content">
          For much of the 20th century, the Fahrenheit scale was defined by two
          fixed points with a 180 °F separation: the temperature at which pure
          water freezes was defined as 32 °F and the boiling point of water was
          defined to be 212 °F, both at sea level and under standard atmospheric
          pressure. It is now formally defined using the Kelvin scale and hence
          ultimately by the Boltzmann constant, the Planck constant, and the
          second {"("}defined as a specific number of cycles of the unperturbed
          ground-state hyperfine transition frequency of the caesium-133 atom.
          {")"}
        </p>
        <p className="span-convert-content">
          It continues to be officially used in the United States {"("}including
          its unincorporated territories{")"}, its freely associated states in
          the Western Pacific {"("}Palau, the Federated States of Micronesia and
          the Marshall Islands{")"}, the Cayman Islands, and the former American
          colony of Liberia.
        </p>
        <p className="span-convert-content">
          Though the United Kingdom changed from Fahrenheit to Celsius in
          metrology, Fahrenheit is sometimes still used in newspaper headlines
          to sensationalise heatwaves.
        </p>
        <li className="li-convert-content">
          <h4>Celsius:</h4>
        </li>
        ...
        <p className="span-convert-content">
          Since 1743, the Celsius scale has been based on 0 °C for the freezing
          point of water and 100 °C for the boiling point of water at 1 atm
          pressure. Prior to 1743 the values were reversed {"("}i.e. the boiling
          point was 0 degrees and the freezing point was 100 degrees{")"}. The
          1743 scale reversal was proposed by Jean-Pierre Christin.
        </p>
        <p className="span-convert-content">
          By international agreement, between 1954 and 2019 the unit degree
          Celsius and the Celsius scale were defined by absolute zero and the
          triple point of water. After 2007, it was clarified that this
          definition referred to Vienna Standard Mean Ocean Water {"("}VSMOW
          {")"}, a precisely defined water standard. This definition also
          precisely related the Celsius scale to the scale of the kelvin, the SI
          base unit of thermodynamic temperature with symbol K. Absolute zero,
          the lowest temperature, is defined as being exactly 0 K and −273.15
          °C. Until 19 May 2019, the temperature of the triple point of water
          was defined as exactly 273.16 K {"("}0.01 °C{")"}.
        </p>
        <p className="span-convert-content">
          ...
          being defined by the triple point of VSMOW. This means that the triple
          point is now a measured value, not a defined value. The newly defined
          exact value of the Boltzmann constant was selected so that the
          measured value of the VSMOW triple point is exactly the same as the
          older defined value to within the limits of accuracy of contemporary
          metrology. The temperature in degree Celsius is now defined as the
          temperature in kelvins subtracted by 273.15, meaning that a
          temperature difference of one degree Celsius and that of one kelvin
          are exactly the same, and that the degree Celsius remains exactly
          equal to the kelvin {"("}i.e., 0 °C remains exactly 273.15 K{")"}.
        </p>
        <li className="li-convert-content">
          <h4>Kelvin:</h4>
        </li>
        ...
        <p className="span-convert-content">
          Historically, the Kelvin scale was developed from the Celsius scale,
          such that 273.15 K was 0 °C {"("}the approximate melting point of ice
          {")"} and a change of one kelvin was exactly equal to a change of one
          degree Celsius. This relationship remains accurate, but the Celsius,
          Fahrenheit, and Rankine scales are now defined in terms of the Kelvin
          scale. The kelvin is the primary unit of temperature for engineering
          and the physical sciences, while in most countries the Celsius scale
          remains the dominant scale outside of these fields. In the United
          States, outside of the physical sciences, the Fahrenheit scale
          predominates, with the kelvin or Rankine scale employed for absolute
          temperature.
        </p>
      </ul>
    </>
